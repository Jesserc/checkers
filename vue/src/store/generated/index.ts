...
import JessercCheckersJessercCheckersCheckers from './jesserc/checkers/jesserc.checkers.checkers'
...
export default { 
  ...
  JessercCheckersJessercCheckersCheckers: load(JessercCheckersJessercCheckersCheckers, 'jesserc.checkers.checkers'),
